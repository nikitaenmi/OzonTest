...
## Описание проекта
Задача сделать мок-сервис, при этом обеспечить надёжность и воспроизводимость тестов. Для решения данной задачи было принято решение сделать API с POST ручкой. 
